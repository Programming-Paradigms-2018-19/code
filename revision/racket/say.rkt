...
;; This version uses "contracts" to check the validity of a call
;; Uses the four steps outlined in the "exercism.io" example 
;; (Not necessarily the most efficient way to solve the problem.)
